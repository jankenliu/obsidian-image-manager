export const zh: Record<string, string> = {
    ...
    'modal.imageBrowser.orphanFilterScanning': '正在扫描...',
    'modal.imageBrowser.showAllImages': '显示全部',
    'modal.imageBrowser.orphanScanning': '正在扫描孤立图片...',
    'modal.imageBrowser.hostedOrphanScanning': '正在扫描图床图片引用...',
    'modal.imageBrowser.localOrphanFilterActive': '已开启孤立图片筛选，仅显示未被引用的本地图片。',
    'modal.imageBrowser.hostedOrphanFilterActive': '已开启孤立图片筛选，仅显示未被笔记引用的图床图片。',
    'modal.imageBrowser.scanningCount': '扫描中...',
    'modal.imageBrowser.loadingCount': '加载中...',
    ...
    'modal.imageBrowser.noHostedOrphans': '该图床中未找到孤立图片。',
    ...
    'modal.imageBrowser.selectImage': '选择“{name}”',
    'modal.imageBrowser.deleteSelected': '删除选中',
    'modal.imageBrowser.deletingSelected': '正在删除...',
    'modal.imageBrowser.noSelection': '请至少选择一张图片。',
    'modal.imageBrowser.deleteLocalBatchTitle': '删除选中的本地孤立图片',
    'modal.imageBrowser.deleteLocalBatchMessage': '确定要将选中的 {count} 张本地孤立图片移到回收站吗？',
    'modal.imageBrowser.deleteHostedBatchTitle': '删除选中的图床孤立图片',
    'modal.imageBrowser.deleteHostedBatchMessage': '确定要从图床永久删除选中的 {count} 张孤立图片吗？此操作不可撤销。',
    'modal.imageBrowser.localBatchDeleted': '已将 {count} 张本地图片移到回收站。',
    'modal.imageBrowser.hostedBatchDeleted': '已从图床删除 {count} 张图片。',
    'modal.imageBrowser.batchDeletePartial': '已删除 {deleted} 张图片，{failed} 张删除失败。失败的图片仍保持选中。',
    'modal.imageBrowser.batchDeleteFailed': '批量删除失败：{error}',
    ...
    'modal.preview.toggleReferences': '展开或收起引用详情',
    ...
    'modal.preview.deleteHosted': '从图床删除',
    'modal.preview.deleteHostedTitle': '删除图床图片',

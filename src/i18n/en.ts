export const en: Record<string, string> = {
    ...
    'modal.imageBrowser.orphanFilterScanning': 'Scanning...',
    'modal.imageBrowser.showAllImages': 'Show all',
    'modal.imageBrowser.orphanScanning': 'Scanning for orphan images...',
    'modal.imageBrowser.hostedOrphanScanning': 'Scanning hosted image references...',
    'modal.imageBrowser.localOrphanFilterActive': 'Orphan filter is active. Only unreferenced local images are shown.',
    'modal.imageBrowser.hostedOrphanFilterActive': 'Orphan filter is active. Only hosted images not referenced by notes are shown.',
    'modal.imageBrowser.scanningCount': 'Scanning...',
    'modal.imageBrowser.loadingCount': 'Loading...',
    ...
    'modal.imageBrowser.noHostedOrphans': 'No orphan images found in this hosting provider.',
    ...
    'modal.imageBrowser.selectImage': 'Select "{name}"',
    'modal.imageBrowser.deleteSelected': 'Delete selected',
    'modal.imageBrowser.deletingSelected': 'Deleting...',
    'modal.imageBrowser.noSelection': 'Select at least one image.',
    'modal.imageBrowser.deleteLocalBatchTitle': 'Delete selected local orphan images',
    'modal.imageBrowser.deleteLocalBatchMessage': 'Move the selected {count} local orphan image(s) to trash?',
    'modal.imageBrowser.deleteHostedBatchTitle': 'Delete selected hosted orphan images',
    'modal.imageBrowser.deleteHostedBatchMessage': 'Permanently delete the selected {count} orphan image(s) from image hosting? This action cannot be undone.',
    'modal.imageBrowser.localBatchDeleted': 'Moved {count} local image(s) to trash.',
    'modal.imageBrowser.hostedBatchDeleted': 'Deleted {count} image(s) from image hosting.',
    'modal.imageBrowser.batchDeletePartial': 'Deleted {deleted} image(s); {failed} failed. Failed images remain selected.',
    'modal.imageBrowser.batchDeleteFailed': 'Batch deletion failed: {error}',
    ...
    'modal.preview.deleteHosted': 'Delete from hosting',
    'modal.preview.deleteHostedTitle': 'Delete hosted image',
